"""Integration Test xmenETLMethods"""
import os
import unittest
...
class IntTestxmenETLMethods(unittest.TestCase):
    """
    Integration testing the xmenETL class.
    """
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xmen-int-test-src'
        self.s3_bucket_name_trg = 'xmen-int-test-trg'
